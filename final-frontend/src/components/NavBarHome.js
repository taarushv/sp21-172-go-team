...
export default class NavBarHome extends Component {
  ...
  <Navbar bg="light" variant="light">
    ...
    <Nav className="mr-auto">
      ...
      {window.localStorage.getItem('username') !== null ? <Nav.Link ><Link to="/report"><h2>Need Help?</h2></Link></Nav.Link>: ''}
    ...
    <Form inline style={{paddingLeft: "700px"}}>
      ...
      {window.localStorage.getItem('username') !== null ? <Nav.Link ><Button  onClick={()=>{
        localStorage.removeItem('username' )
      }}><h2>Logout</h2></Button></Nav.Link>: <Button><a href="/login"><h2 style={{color:"white"}}>Login</h2></a> </Button>}
