package goteam.backend.springcybersource;
...
public class CyberSourceAPI {
    ...
    /*
     * Try with your own credentaials Get Key ID, Secret Key and Merchant Id from
     * EBC portal
     */
    ...
    public static void setMerchant(String m) {
        merchantId = m;
    }
    ...
    /*
     * Sandbox Host: apitest.cybersource.com Production Host: api.cybersource.com
     */
     ...
     * 
     * 001 - Visa 002 - Mastercard, Eurocard1: European regional brand of
     * Mastercard. 003 - American Express 004 - Discover 005 - Diners Club
     * 
     * REF: https://developer.cybersource.com/library/documentation/dev_guides/
     * Retail_SO_API/html/Topics/app_card_types.htm
     */
    ...
    private String sendGet(String url) throws Exception {
        ...
        /*
         * Add Request Header "v-c-merchant-id" set value to Cybersource Merchant ID or
         * v-c-merchant-id This ID can be found on EBC portal
         */
        con.setRequestProperty("v-c-merchant-id", merchantId);
        con.setRequestProperty("v-c-correlation-id", "123");

        /*
         * Add Request Header "Date" The date and time that the message was originated
         * from. "HTTP-date" format as defined by RFC7231.
         */
        gmtDateTime = getdate();
        ...
        /*
         * Add Request Header "Host" Host to send the request to.
         */
        con.setRequestProperty("Host", requestHost);

        /*
         * Add Request Header "Signature" Contains keyId, algorithm, headers and
         * signature as paramters Check getSignatureHeader() method for more details
         */
    ...
    private PostResponse sendPost(String url) {
        ...
        try {
            ...
            /*
             * Add Request Header "Host" Name of the host to send the request to.
             */
            con.setRequestProperty("Host", requestHost);

            /*
             * Add Request Header "Digest" SHA-256 hash of payload that is BASE64 encoded
             */
